		...
		if(typeof this.CONFIG.color_scheme!='undefined'){
			...
			$(".form__field").keyup(function(){
				...
				_self.CONFIG.locations.forEach(function(location){
					if(location.name.toLowerCase().indexOf(keyword)!=-1 || location.address.toLowerCase().indexOf(keyword)!=-1 || location.zipcode.indexOf(keyword)!=-1){
